      ...
      <div className={styles.footerTop}>
        <div className={styles.footerBrand}>
          ...
          <div className={styles.footerSocials}>
            ...
            <a href="mailto:contacto@payday.com.ar" className={styles.socialLink} aria-label="Email">
        ...
        <div className={styles.footerLinks}>
          ...
          <div className={styles.footerCol}>
            ...
            <a href="mailto:contacto@payday.com.ar" className={styles.footerLink}>contacto@payday.com.ar</a>
