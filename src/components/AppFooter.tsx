      ...
      <div className={styles.footerTop}>
        <div className={styles.footerBrand}>
          ...
          <div className={styles.footerSocials}>
            ...
            <a href="mailto:agustinmonzon724@gmail.com" className={styles.socialLink} aria-label="Email">
        ...
        <div className={styles.footerLinks}>
          ...
          <div className={styles.footerCol}>
            ...
            <a href="mailto:agustinmonzon724@gmail.com" className={styles.footerLink}>support@payday.ai</a>
